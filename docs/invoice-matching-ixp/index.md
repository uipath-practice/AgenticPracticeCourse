...
| [**Configure an Agent**](3-configure-agent.md) | Extract data from Invoice using IXP, look up the Purchase Order, Perform Matching and help making decision |
| [**Configure Human Validation**](4-configure-human-validation.md) | Customized Action App designed to help Humans handling exceptions in Action Center |
| [**Configure API Integration**](5-configure-api.md) | Send notification emails and store approved invoices for further processing |
